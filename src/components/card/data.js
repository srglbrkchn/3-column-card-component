const cars = [
    {
        brand: "Sedans",
        info: "Choose a sedan for its affordability and excellent fuel economy. Ideal for cruis" +
                "ing in the city or on your next road trip.",
        pic: <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd"><circle fill="#000" opacity=".201" cx="20" cy="20" r="20"/><path
        ...
        brand: "SUVs",
        info: "Take an SUV for its spacious interior, power, and versatility. Perfect for your " +
        ...
        brand: "Luxury",
        info: "Cruise in the best car brands without the bloated prices. Enjoy the enhanced com" +
                "fort of a luxury rental and arrive in style.",
        pic: <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd"><circle fill="#000" opacity=".201" cx="20" cy="20" r="20"/><path
